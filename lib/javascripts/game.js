...
var Game = Asteroids.Game = function(width, height) {
  ...
  this.base_num_asteroids = Game.QUICK_DEBUG_MODE ? 1 : 8; // Starting number for level 1
  this.base_min_asteroid_speed = Game.QUICK_DEBUG_MODE ? 0.5 : 0.5; // Reverted to original base speed
...
Game.QUICK_DEBUG_MODE = false;

Game.UFO_SPAWN_RATE = Game.QUICK_DEBUG_MODE ? 0 : 0.002;
