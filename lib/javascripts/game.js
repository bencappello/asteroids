...
Game.prototype.handleDeath = function () {
  console.log(">>> handleDeath called. Current this.lives:", this.lives); // Log before calling decrement
  var lives_remaining = this.decrementLives(); // Get instance lives
  var score = this.score; // Store score before potentially resetting
  console.log(">>> handleDeath after decrement. lives_remaining:", lives_remaining, "this.lives:", this.lives);
...
Game.prototype.decrementLives = function() {
    console.log(">>> decrementLives start. this.lives:", this.lives);
    if (this.lives > 0) { // Check instance lives
        this.lives -= 1; // Decrement instance lives
    }
    console.log(">>> decrementLives after decrement. this.lives:", this.lives);
    $('#lives').html(this.lives); // Update the display using instance lives
    console.log("Life decremented. Display updated. Returning:", this.lives);
