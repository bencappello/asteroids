...
Asteroids.Util.loadHighScores = function() {
    ...
    try {
        ...
        if (!highScores || highScores.length === 0) {
            ...
            highScores = [
              { initials: "ACE", score: 20000 },
              { initials: "TOP", score: 18000 },
              { initials: "PRO", score: 16000 },
              { initials: "GAM", score: 14000 },
              { initials: "RKT", score: 12000 },
              { initials: "ZAP", score: 10000 },
              { initials: "MAV", score: 8000 },
              { initials: "DGR", score: 7000 },
              { initials: "JMP", score: 6000 },
              { initials: "RUN", score: 5000 },
              { initials: "FLY", score: 4000 },
              { initials: "SHO", score: 3600 },
              { initials: "LAS", score: 3200 },
              { initials: "EXP", score: 2800 },
              { initials: "WIN", score: 2400 },
              { initials: "HI",  score: 2000 },
              { initials: "SCR", score: 1600 },
              { initials: "ARC", score: 1200 },
              { initials: "RET", score: 800 },
              { initials: "ROX", score: 400 },
            ];
        ...
        // Populate with defaults and save them on error
        console.log("Corrupted high scores found. Pre-populating with defaults.");
        highScores = [
              { initials: "ACE", score: 20000 },
              { initials: "TOP", score: 18000 },
              { initials: "PRO", score: 16000 },
