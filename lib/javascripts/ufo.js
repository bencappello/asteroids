...
Ufo.prototype.collideWith = function (otherObject) {
  if (otherObject instanceof Asteroids.Ship) {
    if (otherObject.invulnerable()) return;
    otherObject.hitByUfo(); // Method to handle ship being hit by UFO
  } else if (otherObject instanceof Asteroids.Bullet) {
    this.game.remove(otherObject);
    this.game.incrementScore(100); // Use game method
    this.game.remove(this);
    // TODO: Add UFO explosion animation
